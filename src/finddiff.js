...
const findDiff = (object1, object2) => {
  ...
  const result = allKeys.reduce((acc, key) => {
    ...
    if (_.isPlainObject(value1) && !(value2 === undefined)) {
      return [...acc, {
        key, value: value2, status: 'updated', previousValue: parseObject(value1),
      }];
    }
    ...
    if (_.isPlainObject(value2) && !(value1 === undefined)) {
      return [...acc, {
        key, value: parseObject(value2), status: 'updated', previousValue: value1,
      }];
    }
    ...
    if (value1 === value2) {
      ...
      return [...acc, {
        key, value: value2, status: 'updated', previousValue: value1,
      }];
    }
    return acc;
  }, []);
